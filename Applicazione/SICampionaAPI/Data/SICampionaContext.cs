...
public partial class SICampionaContext : DbContext
{
    ...
    public virtual DbSet<PrelevatoreSelezionabile> PRELEVATORI_SELEZIONABILI { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CampionamentoDB>(entity =>
        {
            ...
            entity.Property(e => e.SUFFISSO_CARTELLA)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.CF_OPERATORE_CREAZIONE)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.ULTIMO_AGG_OPER_CF)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.CODICE_SEDE_ACCETTAZIONE)
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.DATA_APERTURA_CAMPIONE).HasColumnType("DATE");
            entity.Property(e => e.ORA_APERTURA_CAMPIONE)
                .HasMaxLength(5)
                .IsUnicode(false);
            entity.Property(e => e.EMAIL_INVIO_VERBALE)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.PEC_INVIO_VERBALE)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.CAMPIONAMENTO_COLLEGATO)
                .HasMaxLength(100)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<PrelevatoreSelezionabile>(entity =>
        {
            entity.HasKey(e => e.ID_PRELEVATORE).HasName("PRELEVATORI_SELEZIONABILI_PK");
            ...
            entity.HasOne(d => d.ID_CAMPIONAMENTONavigation).WithMany(p => p.PRELEVATORI_SELEZIONABILI)
                .HasForeignKey(d => d.ID_CAMPIONAMENTO)
                .HasConstraintName("PRELEVATORI_SELEZIONABILI_FK1");
        });
        ...
        modelBuilder.HasSequence("PRELEVATORI_SELEZIONABILI_SEQ");
    }
}
