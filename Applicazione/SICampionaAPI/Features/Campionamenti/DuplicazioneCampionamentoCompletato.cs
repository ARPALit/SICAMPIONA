...
{
    public class DuplicazioneCampionamentoCompletato(ILogger<OperatoriController> logger, IRepositoryCampionamenti repositoryCampionamenti, IAnagrafiche anagrafiche)
    {
        public class Command(RichiestaDuplicazioneCampionamentoCompletato richiesta, string codiceFiscaleOperatore)
        {
            public RichiestaDuplicazioneCampionamentoCompletato Richiesta { get; } = richiesta;
        ...
        public ResultDto<Result> Run(Command command)
        {
            try
            {
                ...
                Campionamento campionamento = DuplicaCampionamentoCompletato(command, resultConfigurazioneOperatore.Data.Configurazione);
        ...
        /// <returns></returns>
        private Campionamento DuplicaCampionamentoCompletato(Command command, ConfigurazioneOperatore configurazioneOperatore)
        {
            ...
            // I prelevatori vengon opopoalti da quelli disponibili ora
            campionamentoDaDuplicare.PrelevatoriSelezionabili = anagrafiche.Prelevatori(campionamentoDaDuplicare.Ente.Codice, campionamentoDaDuplicare.Argomento.Codice);
