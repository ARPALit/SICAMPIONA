...
namespace SICampiona.Model
{
	...
	public class Campionamento
	{
		...
		/// <summary>
		/// Indica che il campionamento è stato eliminato logicamente
		/// </summary>
	...
	{
		[StringLength(20, ErrorMessage = "La lunghezza massima della latitudine è 20 caratteri")]
		public string Latitudine { get; set; }

		[StringLength(20, ErrorMessage = "La lunghezza massima della longitudine è 20 caratteri")]
	...
	{
		[StringLength(20, ErrorMessage = "La lunghezza massima del codice è 20 caratteri")]
		public string Codice { get; set; }

		[StringLength(100, ErrorMessage = "La lunghezza massima della denominazione è 100 caratteri")]
		[Required(ErrorMessage = "La denominazione è obbligatoria")]
		public string Denominazione { get; set; }

		[StringLength(100, ErrorMessage = "La lunghezza massima dell'indirizzo è 100 caratteri")]
